...
for t in [None, 'normalised', 'theta']:
    ...
    np.savetxt('Results_Bipartite/out_bip_d_prime' + label + '_' + str(K_prime) + '_' + str(args.s) + '.csv', d_scores_prime[t], fmt='%i', delimiter=',')
    np.savetxt('Results_Bipartite/out_bip_K_prime' + label + '_' + str(K_prime) + '_' + str(args.s) + '.csv', K_scores_prime[t], fmt='%i', delimiter=',')
    np.savetxt('Results_Bipartite/est_bip_ari_prime' + label + '_' + str(K_prime) + '_' + str(args.s) + '.csv', ari_scores_prime[t], fmt='%.6f', delimiter=',')